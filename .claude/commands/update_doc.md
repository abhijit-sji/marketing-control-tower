...
- Please consolidate docs as much as possible, no overlay between files, e.g. most basic version just need project_architecture.md, and we can expand from there
