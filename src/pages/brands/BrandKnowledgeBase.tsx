...
import { useBrandKnowledgeBase } from "@/hooks/useBrandKnowledgeBase";
...
export default function BrandKnowledgeBase({ brandId: propBrandId, embedded = false }: BrandKnowledgeBaseProps = {}) {
    ...
    <div className={embedded ? "space-y-6" : "container mx-auto p-6 space-y-6"}>
      ...
      {!embedded && (
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold">Brand Knowledge Base</h1>
        ...
        <TabsContent value="files" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                All files uploaded to your brand's knowledge base
              </CardDescription>
            </CardHeader>
            <CardContent>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              Source: {file.knowledge_sources?.name || 'Unknown'}
                            </p>
                            {file.created_at && (
        ...
        <TabsContent value="upload" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload documents to enhance AI understanding of your brand
              </CardDescription>
            </CardHeader>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Manage knowledge sources for your brand
                  </CardDescription>
                </div>
                      ...
                      <div className="flex items-center gap-2">
                        {source.type === 'google_drive' && (
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => syncGoogleDriveSource.mutate(source.id)}
                            disabled={syncGoogleDriveSource.isPending}
                          >
                            {syncGoogleDriveSource.isPending ? (
      ...
      <DeleteFileDialog
        ...
        onConfirm={async (fileId) => {
          // Use the new edge function that properly deletes from storage, embeddings, and database
